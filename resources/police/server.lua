    ...
    if #args > 1 then
        ...
        if LOADOUTS[arg] then
            ...
            if user.permission_level >= (loadout.permission_level or 0) then
                ...
                TriggerClientEvent("loadout:missiontext", source, "Tu as maintenant le grade de " .. loadout.name, 5000)
            ...
            print("no permission")
            TriggerClientEvent("loadout:missiontext", source, "Tu n'as pas la permission pour devenir " .. loadout.name .. " ", 5000)
        ...
        TriggerClientEvent('chatMessage', source, "Loadouts", {255, 255, 255}, "Utilise /police recrue ou brigadier ou sergent pour devenir flic.")
    end
end)
